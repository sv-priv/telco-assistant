...
title: Услови за кампања — Летна промоција 2025
source: operator
authority: operator
family: campaign
language: mk
...
| Ставка | Вредност |
|---|---|
| Пакет во понудата | Вардар Мобилен L |
| Попуст на месечна претплата | 25% |
| Времетраење на попустот | првите 12 месеци |
| Редовна претплата по попустот | 1.249 ден. |
