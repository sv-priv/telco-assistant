---
doc_id: op-coverage-makedonski-brod
title: Покриеност — Македонски Брод
source: operator
authority: operator
family: coverage
language: mk
...
| Просечна брзина 5G | 312 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Македонски Брод.
...
Проширувањето на мрежата во Македонски Брод продолжува. Информации за планирани прекини се
