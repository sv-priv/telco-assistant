---
doc_id: op-coverage-resen
title: Покриеност — Ресен
source: operator
authority: operator
family: coverage
language: mk
...
| Просечна брзина 5G | 282 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Ресен.
...
Проширувањето на мрежата во Ресен продолжува. Информации за планирани прекини се
