---
doc_id: op-coverage-prilep
title: Покриеност — Прилеп
source: operator
authority: operator
family: coverage
language: mk
...
| Просечна брзина 5G | 168 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Прилеп.
...
Проширувањето на мрежата во Прилеп продолжува. Информации за планирани прекини се
