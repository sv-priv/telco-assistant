---
doc_id: op-coverage-ohrid
title: Покриеност — Охрид
source: operator
authority: operator
family: coverage
language: mk
...
| Просечна брзина 5G | 192 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Охрид.
...
Проширувањето на мрежата во Охрид продолжува. Информации за планирани прекини се
