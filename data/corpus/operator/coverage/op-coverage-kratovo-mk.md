---
doc_id: op-coverage-kratovo
title: Покриеност — Кратово
source: operator
authority: operator
family: coverage
language: mk
...
| Покриеност 5G | 13% |
| Базни станици | 4 |
| Просечна брзина 4G | 39 Mbps |
| Просечна брзина 5G | 300 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Кратово.
...
Проширувањето на мрежата во Кратово продолжува. Информации за планирани прекини се
