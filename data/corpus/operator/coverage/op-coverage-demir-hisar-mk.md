---
doc_id: op-coverage-demir-hisar
title: Покриеност — Демир Хисар
source: operator
authority: operator
family: coverage
language: mk
...
| Просечна брзина 5G | 306 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Демир Хисар.
...
Проширувањето на мрежата во Демир Хисар продолжува. Информации за планирани прекини се
