---
doc_id: op-coverage-radovis
title: Покриеност — Радовиш
source: operator
authority: operator
family: coverage
language: mk
...
| Покриеност 5G | 46% |
| Базни станици | 5 |
| Просечна брзина 4G | 46 Mbps |
| Просечна брзина 5G | 234 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Радовиш.
...
Проширувањето на мрежата во Радовиш продолжува. Информации за планирани прекини се
