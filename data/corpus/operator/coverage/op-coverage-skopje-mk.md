---
doc_id: op-coverage-skopje
title: Покриеност — Скопје
source: operator
authority: operator
family: coverage
language: mk
...
| Просечна брзина 5G | 150 Mbps |

## Забелешки за подрачјето

5G е достапно во централните делови на Скопје.
...
Проширувањето на мрежата во Скопје продолжува. Информации за планирани прекини се
